...
import { ArrowLeft, Save, User, UserCircle, UserIcon } from "lucide-react";
              ...
              <div>
                ...
                {isEdit ? (
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-700 rounded-lg border border-gray-600 ">
                        ...
                        <button onClick={editHandler} className="flex items-center justify-between p-4 bg-gray-600 hover:bg-gray-500 rounded-lg border border-gray-600 text-white">Edit</button>
                    </div>
                    )
                }
              </div>

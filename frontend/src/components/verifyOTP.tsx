      ...
      <div className="max-w-md w-full">
        <div className="bg-gray-800 border-gray-700 rounded-lg p-8">
          ...
          {timer > 0 ? (
            ...
            <button className="text-blue-400 hover:text-blue-300 font-medium text-sm desabled:opacity-50" disabled={resendLoading} onClick={handleResendOTP}>{resendLoading? "Sending...":"Resend Code"}</button> 
          )}
        </div>
      </div>
    </div>
